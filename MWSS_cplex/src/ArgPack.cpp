	...
	p{1,1,4,1}
{
	...
	string usage = string("Usage: ") + program_name + " [options] <instance file> <weight file>\n" +
...
//	               "	-o<output>      : output solution file [default: " + output_name + "]\n" +
	               ...
	               "	-T<time>		: stop execution if the execution time exceeds a certain time [default: " + to_string(time) + "]\n" +
