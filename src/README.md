...
1. The *primal* model whose main file is `./primal/primal_solve.mzn`
2. The *dual* model whose main file is `./dual/dual_solve.mzn`
3. The *joint* model whose main file is `./joint/joint_solve.mzn`
