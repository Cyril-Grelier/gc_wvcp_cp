...
def main():
    ...
    methods: list[tuple(str, str)] = [
        # ls - mcts+ls
        ("AFISA", "ls_all/afisa_original"),
        ("MCTS+AFISA", "mcts_ls_all/afisa_original"),
        ("TabuWeight", "ls_all/tabu_weight"),
        ("MCTS+TabuWeight", "mcts_ls_all/tabu_weight"),
        ("RedLS", "ls_all/redls"),
        ("MCTS+RedLS", "mcts_ls_all/redls"),
        ("ILSTS", "ls_all/ilsts"),
        ("MCTS+ILSTS", "mcts_ls_all/ilsts"),
        # ad
        ("Random", "ad_all/random"),
        # ("Deleter", "ad_all/deleter"),
        ("Roulette Wheel", "ad_all/roulette_wheel"),
        ("Pursuit", "ad_all/pursuit"),
        ("UCB", "ad_all/ucb"),
        ("NN", "ad_all/neural_net"),
        # # ns
        # ("MCTS+RedLS", "mcts_ls_all/redls"),
        # ("depth", "ns_redls_hard_wvcp/depth"),
        # ("fit", "ns_redls_hard_wvcp/fit"),
        # ("depth_fit", "ns_redls_hard_wvcp/depth_fit"),
        # ("level", "ns_redls_hard_wvcp/level"),
        # ("chance", "ns_redls_hard_wvcp/chance"),
        # # 5h
        # ("AFISA 5h", "5h_non_optimal/afisa_original"),
        # ("TabuWeight 5h", "5h_non_optimal/tabu_weight"),
        # ("RedLS 5h", "5h_non_optimal/redls"),
        # ("ILSTS 5h", "5h_non_optimal/ilsts"),
        # ("MCTS+RedLS 5h", "5h_non_optimal/mcts_redls"),
        # ("Deleter 5h", "5h_non_optimal/deleter"),
        # ("Pursuit 5h", "5h_non_optimal/pursuit"),
        # ("NN 5h", "5h_non_optimal/neural_net"),
    ]
    ...
    output_file = f"xlsx_files/1h_rerun_{instances_set[1]}.xlsx"
