...
def main():
    ...
    methods: list[tuple(str, str)] = [
        ...
        # ("primal S/D bounds parallel", "primal_h1_SR2_DR2_all_bounds_parallel_20h"),
        # ("joint S/D bounds parallel", "joint_h1_SR2_DR1_DR2_all_bounds_parallel_20h"),
    ]

    for i, method in enumerate(methods):
        # methods[i] = (method[0], "cp_20h_try_hard/" + method[1])
    ...
    output_file = f"xlsx_files/table_parallel_{instances_set[1]}.xlsx"
    ...
    # output_file = f"xlsx_files/E5_parallel_20h_{instances_set[1]}.xlsx"
...
class Method:
    def __init__(
        ...
        cplex_file = f"outputs/{repertory}/{instance_name}.cplex"
            ...
            with open(cplex_file, "r", encoding="utf8") as file:
                for line in file.readlines():
                    ...
                    if line.startswith("Status"):
                        self.optimal = line.split()[-1] == "Optimal"
